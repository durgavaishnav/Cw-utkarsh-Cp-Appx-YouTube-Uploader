...
credit ="Alex:)™~" 
OWNER = int(os.environ.get("OWNER", 6180010666))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "6180010666 1668330461").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="7586805769:AAHX_utgKWZF5tqBzdhdqGI1vXCd2uVEoTU",    
   api_id= 22716696,    
   api_hash= "38b5457ccd713d2862140f5a0a3833e5"
)
